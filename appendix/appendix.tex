...
{\noindent}\textbf{Gradient (adiabatic)}: $\nabla_{\rm ad} ~ [{\rm ???}]$

{\noindent}\textbf{Gradient (radiative)}: $\nabla_{\rm rad} ~ [{\rm K\,P^{-1}}]$
...
{\noindent}\textbf{Temperature gradient (radiative transport)}: $\dfrac{{\rm d}T}{{\rm d}r} ~ [{\rm K\,m6{-1}}]$
...
{\noindent}\textbf{Temperature gradient (radiative transport)}:
\begin{align*}

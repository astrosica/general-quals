...
\begin{figure}[h]
    \centering
    \includegraphics[width=10cm]{figures/GalaxySED.jpg}
...
The spectral energy distribution (SED; see Figure \ref{fig:galaxySED}) of a typical galaxy is dominated by several processes:
